...
from app.routes import attendance, students, reports, notifications, cameras, websocket, mjpeg_stream, auth
from app.routes import announcements, parent, admin
...
async def health_check():
    ...
    try:
        async with httpx.AsyncClient(timeout=2.0) as client:
            r = await client.get("http://localhost:8091/api/health")
